...
public class MemberServer {
    ...
    public MemberServer() throws IOException, SQLException {
        ...
        new MemberServer().run();
    }

    public static void main(String[] args) throws IOException, SQLException {
        HttpServer httpServer = new HttpServer(8080);
        httpServer.setFileLocation("src/main/resources");
        httpServer.addController("/api/members", new MemberHttpController(new MemberDao(dataSource)));
        httpServer.start();
